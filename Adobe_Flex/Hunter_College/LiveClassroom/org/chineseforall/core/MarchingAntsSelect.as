	...
	public class MarchingAntsSelect extends Sprite {
		...
		private function setUpMarquee():void {
			...
			if (userDrawSelect) {
				...
				var bg:Sprite = drawShape((point2.x - point1.x)-lineThickness*2, (point2.y-point1.y)-lineThickness*2, 0xFFFF00,0);
		...
		private function drawShape(w:Number, h:Number, col:int, trans:Number):Sprite {
