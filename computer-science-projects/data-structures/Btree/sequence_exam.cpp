...
int main( )
{
    ...
    cout << "If you submit your answer to Assignment 2 (Chapter 3 sequence) to us now, you will have\n";
    cout << sum << " points out of the " << POINTS[0];
    cout << " points from this test program.\n";
    cout << " The other 20 points will be given by looking at your code\n";
